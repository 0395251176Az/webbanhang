...
SECRET_KEY = 'django-insecure-qg+jhve90vm_!^camtcyx2)xn8@ru)5xveuz6pvub+%c$&d4dt'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*','172.31.32.138']
...
DATABASES = {
    'default': {
        ...
        'USER':'admin',
        'PASSWORD':'123456Aa',
        'HOST':'admin.cdiic4yea1gr.ap-southeast-1.rds.amazonaws.com',      
    }
}
